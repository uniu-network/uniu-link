...
const form = ref<any>({ name: '', display_name: '', routing_strategy: 'default', custom_js: '', failover_enabled: true, is_listed: true, supports_thinking: false, default_thinking_effort: 'none', claude_thinking_mode: 'adaptive' })
...
function openCreate() { isEditing.value = false; form.value = { name: '', display_name: '', routing_strategy: 'default', custom_js: '', failover_enabled: true, is_listed: true, supports_thinking: false, default_thinking_effort: 'none', claude_thinking_mode: 'adaptive' }; modelRefs.value = []; targetError.value = ''; targetForm.value = newTargetForm(); dialogVisible.value = true }
